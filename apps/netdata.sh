...
[ $1 = update ] && { git -C netdada pull; .$HOME/netdata/netdata-installer.sh; whitpail --msgbox "netdata updated!" 8 32; exit; }
[ $1 = remove ] && { sh sysutils/Caddy.sh; sh sysutils/service.sh remove netdata ; rm -rf ~/netdata; rm -rf /etc/netdata; rm -r /usr/sbin/netdata; whitpail --msgbox "netdata removed!" 8 32; exit; }
