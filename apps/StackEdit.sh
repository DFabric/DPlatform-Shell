...
[ $1 = update ] && { git -C /home/stackedit pull; whitpail --msgbox "StackEdit updated!" 8 32; exit; }
[ $1 = remove ] && { sh sysutils/service.sh remove StackEdit; userdel -r stackedit; whitpail --msgbox "StackEdit removed!" 8 32; exit; }
