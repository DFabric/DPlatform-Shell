...
[ "$1" = remove ] && { sh sysutils/service.sh remove TheLounge; npm uninstall thelounge; userdel -rf thelounge; groupdel thelounge;  whiptail --msgbox "The Lounge removed." 8 32; break; }
