...
[ "$1" = remove ] && { sh sysutils/service.sh remove Seafile; sh sysutils/service.sh remove Seahub; rm -rf ~/haiwen; rm -rf ~/seafile-server*; userdel -rf seafile; groupdel seafile; whiptail --msgbox "Seafile removed." 8 32; break; }
