...
[ $1 = update ] && { $install jigasi jitsi-meet jicofo jitsi-videobridge; whitpail --msgbox "Jitsi Meet updated!" 8 32; exit; }
[ $1 = remove ] && { $remove jigasi jitsi-meet jicofo jitsi-videobridge; whitpail --msgbox "Jitsi Meet removed!" 8 32; exit; }
