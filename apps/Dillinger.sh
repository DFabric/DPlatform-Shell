...
[ $1 = update ] && { git -C ~/dillinger pull; whiptail --msgbox "Dillinger updated!" 8 32; break; }
[ $1 = remove ] && { sh sysutils/service.sh remove Dillinger; rm -rf ~/feedbin; whiptail --msgbox "Dillinger  updated!" 8 32; break; }
