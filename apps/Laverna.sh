...
[ $1 = update ] && { git -C /var/www/static-laverna pull; whitpail --msgbox "Laverna updated!" 8 32; exit; }
[ $1 = remove ] && { /var/www/static-laverna; rm /etc/nginx/sites-*/laverna; systemctl restart nginx; whitpail --msgbox "Laverna removed!" 8 32; exit; }
