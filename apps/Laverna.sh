...
[ $1 = update ] && { git -C /var/www/static-laverna pull; whiptail --msgbox "Laverna updated!" 8 32; exit; }
[ $1 = remove ] && { /var/www/static-laverna; rm /etc/nginx/sites-*/laverna; systemctl restart nginx; whiptail --msgbox "Laverna removed!" 8 32; exit; }
