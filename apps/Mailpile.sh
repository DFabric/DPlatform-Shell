...
[ $1 = update ] && { cd ~/Mailpile; git pull; git submodule update; whitpail --msgbox "Mailpile updated!" 8 32; exit; }
[ $1 = remove ] && { sh sysutils/service.sh remove Mailpile; rm -rf ~/Mailpile; whitpail --msgbox "Mailpile removed!" 8 32; exit; }
