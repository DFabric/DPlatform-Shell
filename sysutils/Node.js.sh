...
[ $1 = update ] && [ $ARCH != arm64 ] && [ $PKG = deb ] && [ `id -u` = 0 ] && { apt-get update; $install nodejs; whitpail --msgbox "Node.js updated!" 8 32; exit; }
[ $1 = update ] && [ $ARCH != arm64 ] && [ $PKG = rpm ] && [ `id -u` != 0 ] && { yum update; $install nodejs; whitpail --msgbox "Node.js updated!" 8 32; exit; }
